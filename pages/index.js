      ...
      <div className="lg:flex flex-row-reverse justify-between items-center lg:px-12 lg:mt-36">
        ...
        <div className="px-8 lg:px-0 pt-6 leading-loose text-lg relative inline-block space-y-1 lg:space-y-0 lg:flex lg:flex-[6] flex-col items-endtems-start">
          ...
          <div className="space-y-1 lg:pt-4">
            ...
            <p>
              I started coding at the age of twelve, and I haven't stopped
              since! I adore the capabilities of any form of technology that
              I've ever met, especially the computer. Right about two years ago,
              I started my freelancing career with only some skills on my belt
              and when I'm still a high schooler! From that point, I started
              learning full-stack web development and mobile development using
              Flutter and Swift while gradually gaining more and more client
              connections.
            </p>
          </div>
